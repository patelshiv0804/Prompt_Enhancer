...
async def create_style_profile(payload: CreateStyleProfileRequest, db: AsyncSession = Depends(get_session)):
...
async def duplicate_style_profile(id: uuid.UUID, db: AsyncSession = Depends(get_session)):
