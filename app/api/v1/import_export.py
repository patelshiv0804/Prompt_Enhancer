...
async def import_style_profile(payload: ImportStyleRequest, db: AsyncSession = Depends(get_session)):
...
async def export_style_profile(id: uuid.UUID, db: AsyncSession = Depends(get_session)):
